...
- [[file:./code/support_functions.R::460]][Line 460] :: : There might be some errors with the input data and with the area plot as well
- [[file:./code/support_functions.R::493]][Line 493] :: : Add GDP growth?
- [[file:./code/support_functions.R::823]][Line 823] :: : Increase the space between groups
